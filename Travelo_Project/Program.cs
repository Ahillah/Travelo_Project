...
using Persistance;
using Persistance.Repositories.Tours;
using ServiceAbstraction.Tours;
using ServiceImplementation.MappingProfiles.Tours;
using ServiceImplementation.Tours;
using System.Text;
...
namespace Travelo_Project
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services
             .AddControllers()
             .AddApplicationPart(typeof(presentation.Controllers.Tour.ToursController).Assembly)
